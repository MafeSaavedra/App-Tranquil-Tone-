                        ...
                        children: [
                          InkWell(
                            ...
                            onTap: () async {
                              ...
                              _model.soundPlayer1!
                                  .setAsset('assets/audios/fruta.mp3')
                        ...
                        Padding(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              ...
                              _model.soundPlayer4!.setVolume(0.81);
                              _model.soundPlayer4!
                    ...
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        child: ClipRRect(
                          borderRadius: BorderRadius.circular(8.0),
                          child: Image.asset(
                            'assets/images/professional_multicolor_concept_map_graphic_(17).png',
                            width: 150.0,
                            height: 150.0,
                            fit: BoxFit.contain,
                          ),
                      ...
                      children: [
                        InkWell(
                          ...
                          onTap: () async {
                            ...
                            _model.soundPlayer7!
                                .setAsset('assets/audios/servilletasingles.mp3')
                                .then((_) => _model.soundPlayer7!.play());
                          },
                          child: ClipRRect(
                            borderRadius: BorderRadius.circular(8.0),
                            child: Image.asset(
                              'assets/images/professional_multicolor_concept_map_graphic_(16).png',
                              width: 150.0,
                              height: 150.0,
                              fit: BoxFit.contain,
                            ),
                        ...
                        InkWell(
                          ...
                          child: ClipRRect(
                            borderRadius: BorderRadius.circular(8.0),
                            child: Image.asset(
                              'assets/images/professional_multicolor_concept_map_graphic_(15).png',
                              width: 150.0,
                              height: 150.0,
                              fit: BoxFit.contain,
                            ),
                      ...
                      children: [
                        InkWell(
                          ...
                          child: ClipRRect(
                            borderRadius: BorderRadius.circular(8.0),
                            child: Image.asset(
                              'assets/images/professional_multicolor_concept_map_graphic_(12).png',
                              width: 150.0,
                              height: 150.0,
                              fit: BoxFit.contain,
                            ),
                        ...
                        InkWell(
                          ...
                          child: ClipRRect(
                            borderRadius: BorderRadius.circular(8.0),
                            child: Image.asset(
                              'assets/images/professional_multicolor_concept_map_graphic_(14).png',
                              width: 150.0,
                              height: 150.0,
                              fit: BoxFit.contain,
                            ),
                    ...
                    InkWell(
                      ...
                      onTap: () async {
                        ...
                        _model.soundPlayer11!
                            .setAsset('assets/audios/bebidaingles.mp3')
                            .then((_) => _model.soundPlayer11!.play());
                      },
                      child: ClipRRect(
                        borderRadius: BorderRadius.circular(8.0),
                        child: Image.asset(
                          'assets/images/professional_multicolor_concept_map_graphic_(13).png',
                          width: 120.0,
                          height: 150.0,
                          fit: BoxFit.contain,
                        ),
                    ...
                    InkWell(
                      ...
                      onTap: () async {
                        ...
                        _model.soundPlayer12!
                            .setAsset('assets/audios/vaso_de_agua_(1).mp3')
                            .then((_) => _model.soundPlayer12!.play());
                      },
                      child: ClipRRect(
                        borderRadius: BorderRadius.circular(8.0),
                        child: Image.asset(
                          'assets/images/professional_multicolor_concept_map_graphic_(18).png',
                          width: 150.0,
                          height: 150.0,
                          fit: BoxFit.contain,
                        ),
