...
import 'horario_pm_ingles_model.dart';
export 'horario_pm_ingles_model.dart';

class HorarioPmInglesWidget extends StatefulWidget {
  const HorarioPmInglesWidget({super.key});

  @override
  State<HorarioPmInglesWidget> createState() => _HorarioPmInglesWidgetState();
}

class _HorarioPmInglesWidgetState extends State<HorarioPmInglesWidget> {
  late HorarioPmInglesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HorarioPmInglesModel());
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    ...
                                    await _model.soundPlayer1!
                                        .setAsset(
                                            'assets/audios/12_pm_ing__Hecho_con_Clipchamp.mp3')
                                        .then(
                                  ...
                                  child: Padding(
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        ...
                                        _model.soundPlayer2!
                                            .setAsset(
                                                'assets/audios/1_pm_ing__Hecho_con_Clipchamp.mp3')
                                            .then((_) =>
                    ...
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          ...
                          _model.soundPlayer3!
                              .setAsset(
                                  'assets/audios/2_pm_ing__Hecho_con_Clipchamp.mp3')
                              .then((_) => _model.soundPlayer3!.play());
                        },
                        child: ClipRRect(
                          borderRadius: BorderRadius.circular(8.0),
                          child: Image.asset(
                            'assets/images/2_pm.png',
                            width: 150.0,
                            height: 150.0,
                            fit: BoxFit.contain,
                          ),
                        ...
                        Padding(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              ...
                              _model.soundPlayer4!
                                  .setAsset(
                                      'assets/audios/3_pm_ing__Hecho_con_Clipchamp.mp3')
                                  .then((_) => _model.soundPlayer4!.play());
                            },
                            child: ClipRRect(
                              borderRadius: BorderRadius.circular(8.0),
                              child: Image.asset(
                                'assets/images/3_pm.png',
                                width: 150.0,
                                height: 150.0,
                                fit: BoxFit.contain,
                              ),
                          ...
                          child: Padding(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                ...
                                _model.soundPlayer5!
                                    .setAsset(
                                        'assets/audios/4_pm_ing__Hecho_con_Clipchamp.mp3')
                                    .then((_) => _model.soundPlayer5!.play());
                              },
                              child: ClipRRect(
                                borderRadius: BorderRadius.circular(8.0),
                                child: Image.asset(
                                  'assets/images/hora_4.png',
                                  width: 150.0,
                                  height: 150.0,
                                  fit: BoxFit.contain,
                                ),
                        ...
                        Padding(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              ...
                              _model.soundPlayer6!
                                  .setAsset(
                                      'assets/audios/5_pm_ing__Hecho_con_Clipchamp.mp3')
                                  .then((_) => _model.soundPlayer6!.play());
                            },
                            child: ClipRRect(
                              borderRadius: BorderRadius.circular(8.0),
                              child: Image.asset(
                                'assets/images/5_pm.png',
                                width: 150.0,
                                height: 150.0,
                                fit: BoxFit.contain,
                              ),
                    ...
                    Align(
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          ...
                          _model.soundPlayer7!
                              .setAsset(
                                  'assets/audios/6_pm_ing__Hecho_con_Clipchamp.mp3')
                              .then((_) => _model.soundPlayer7!.play());
                        },
                        child: ClipRRect(
                          borderRadius: BorderRadius.circular(8.0),
                          child: Image.asset(
                            'assets/images/6_pm-removebg-preview.png',
                            width: 150.0,
                            height: 150.0,
                            fit: BoxFit.contain,
                          ),
                    ...
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          ...
                          _model.soundPlayer8!
                              .setAsset(
                                  'assets/audios/7_pm_ing__Hecho_con_Clipchamp.mp3')
                              .then((_) => _model.soundPlayer8!.play());
                        },
                        child: ClipRRect(
                          borderRadius: BorderRadius.circular(8.0),
                          child: Image.asset(
                            'assets/images/7_pm-removebg-preview.png',
                            width: 150.0,
                            height: 150.0,
                            fit: BoxFit.contain,
                          ),
                  ...
                  children: [
                    InkWell(
                      ...
                      onTap: () async {
                        ...
                        _model.soundPlayer9!
                            .setAsset(
                                'assets/audios/8_pm_ing__Hecho_con_Clipchamp.mp3')
                            .then((_) => _model.soundPlayer9!.play());
                      },
                      child: ClipRRect(
                        borderRadius: BorderRadius.circular(8.0),
                        child: Image.asset(
                          'assets/images/8_pm-removebg-preview.png',
                          width: 150.0,
                          height: 150.0,
                          fit: BoxFit.contain,
                        ),
                    ...
                    InkWell(
                      ...
                      onTap: () async {
                        ...
                        _model.soundPlayer10!
                            .setAsset(
                                'assets/audios/9_pm_ing__Hecho_con_Clipchamp.mp3')
                    ...
                    InkWell(
                      ...
                      onTap: () async {
                        ...
                        _model.soundPlayer11!
                            .setAsset(
                                'assets/audios/10_pm_ing__Hecho_con_Clipchamp.mp3')
                            .then((_) => _model.soundPlayer11!.play());
                      },
                      child: ClipRRect(
                        borderRadius: BorderRadius.circular(8.0),
                        child: Image.asset(
                          'assets/images/10_pm.png',
                          width: 150.0,
                          height: 150.0,
                          fit: BoxFit.contain,
                        ),
                    ...
                    InkWell(
                      ...
                      onTap: () async {
                        ...
                        _model.soundPlayer12!
                            .setAsset(
                                'assets/audios/11_pm_ing__Hecho_con_Clipchamp.mp3')
                            .then((_) => _model.soundPlayer12!.play());
                      },
                      child: ClipRRect(
                        borderRadius: BorderRadius.circular(8.0),
                        child: Image.asset(
                          'assets/images/11_pm-removebg-preview.png',
                          width: 150.0,
                          height: 150.0,
                          fit: BoxFit.contain,
                        ),
