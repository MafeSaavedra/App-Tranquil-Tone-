...
import 'horario_am_ingles_model.dart';
export 'horario_am_ingles_model.dart';

class HorarioAmInglesWidget extends StatefulWidget {
  const HorarioAmInglesWidget({super.key});

  @override
  State<HorarioAmInglesWidget> createState() => _HorarioAmInglesWidgetState();
}

class _HorarioAmInglesWidgetState extends State<HorarioAmInglesWidget> {
  late HorarioAmInglesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HorarioAmInglesModel());
                              ...
                              child: Padding(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    ...
                                    _model.soundPlayer1!
                                        .setAsset(
                                            'assets/audios/12_am_ing__Hecho_con_Clipchamp.mp3')
                                        .then(
                                  ...
                                  child: Padding(
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        ...
                                        _model.soundPlayer2!
                                            .setAsset(
                                                'assets/audios/1_am_ing__Hecho_con_Clipchamp.mp3')
                                            .then((_) =>
                    ...
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          ...
                          _model.soundPlayer3!
                              .setAsset(
                                  'assets/audios/2_am_ing__Hecho_con_Clipchamp.mp3')
                              .then((_) => _model.soundPlayer3!.play());
                        },
                        child: ClipRRect(
                          borderRadius: BorderRadius.circular(8.0),
                          child: Image.asset(
                            'assets/images/2_am.png',
                            width: 150.0,
                            height: 150.0,
                            fit: BoxFit.contain,
                          ),
                        ...
                        Padding(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              ...
                              _model.soundPlayer4!
                                  .setAsset(
                                      'assets/audios/3_am_ing__Hecho_con_Clipchamp.mp3')
                                  .then((_) => _model.soundPlayer4!.play());
                            },
                            child: ClipRRect(
                              borderRadius: BorderRadius.circular(8.0),
                              child: Image.asset(
                                'assets/images/3_am.png',
                                width: 150.0,
                                height: 150.0,
                                fit: BoxFit.contain,
                              ),
                          ...
                          child: Padding(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                ...
                                _model.soundPlayer5!
                                    .setAsset(
                                        'assets/audios/4_am_ing__Hecho_con_Clipchamp.mp3')
                                    .then((_) => _model.soundPlayer5!.play());
                              },
                              child: ClipRRect(
                                borderRadius: BorderRadius.circular(8.0),
                                child: Image.asset(
                                  'assets/images/4_am.png',
                                  width: 150.0,
                                  height: 150.0,
                                  fit: BoxFit.contain,
                                ),
                        ...
                        Padding(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              ...
                              _model.soundPlayer6!
                                  .setAsset(
                                      'assets/audios/5_am_ing__Hecho_con_Clipchamp.mp3')
                                  .then((_) => _model.soundPlayer6!.play());
                            },
                            child: ClipRRect(
                              borderRadius: BorderRadius.circular(8.0),
                              child: Image.asset(
                                'assets/images/5_am.png',
                                width: 150.0,
                                height: 150.0,
                                fit: BoxFit.contain,
                              ),
                    ...
                    Align(
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          ...
                          _model.soundPlayer7!
                              .setAsset(
                                  'assets/audios/6_am_ing__Hecho_con_Clipchamp.mp3')
                              .then((_) => _model.soundPlayer7!.play());
                        },
                        child: ClipRRect(
                          borderRadius: BorderRadius.circular(8.0),
                          child: Image.asset(
                            'assets/images/6_am.png',
                            width: 150.0,
                            height: 150.0,
                            fit: BoxFit.contain,
                          ),
                    ...
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          ...
                          _model.soundPlayer8!
                              .setAsset(
                                  'assets/audios/7_am_ing__Hecho_con_Clipchamp.mp3')
                              .then((_) => _model.soundPlayer8!.play());
                        },
                        child: ClipRRect(
                          borderRadius: BorderRadius.circular(8.0),
                          child: Image.asset(
                            'assets/images/7_am.png',
                            width: 150.0,
                            height: 150.0,
                            fit: BoxFit.contain,
                          ),
                  ...
                  children: [
                    InkWell(
                      ...
                      onTap: () async {
                        ...
                        _model.soundPlayer9!
                            .setAsset(
                                'assets/audios/8_am_ing__Hecho_con_Clipchamp.mp3')
                            .then((_) => _model.soundPlayer9!.play());
                      },
                      child: ClipRRect(
                        borderRadius: BorderRadius.circular(8.0),
                        child: Image.asset(
                          'assets/images/8_am.png',
                          width: 150.0,
                          height: 150.0,
                          fit: BoxFit.contain,
                        ),
                    ...
                    InkWell(
                      ...
                      onTap: () async {
                        ...
                        _model.soundPlayer10!
                            .setAsset(
                                'assets/audios/9_am_ing__Hecho_con_Clipchamp.mp3')
                            .then((_) => _model.soundPlayer10!.play());
                      },
                      child: ClipRRect(
                        borderRadius: BorderRadius.circular(8.0),
                        child: Image.asset(
                          'assets/images/9_am.png',
                          width: 150.0,
                          height: 150.0,
                          fit: BoxFit.contain,
                        ),
                    ...
                    InkWell(
                      ...
                      onTap: () async {
                        ...
                        _model.soundPlayer11!
                            .setAsset(
                                'assets/audios/10_am_ing__Hecho_con_Clipchamp.mp3')
                            .then((_) => _model.soundPlayer11!.play());
                      },
                      child: ClipRRect(
                        borderRadius: BorderRadius.circular(8.0),
                        child: Image.asset(
                          'assets/images/10_am.png',
                          width: 150.0,
                          height: 150.0,
                          fit: BoxFit.contain,
                        ),
                    ...
                    InkWell(
                      ...
                      onTap: () async {
                        ...
                        _model.soundPlayer12!
                            .setAsset(
                                'assets/audios/11_am_ing__Hecho_con_Clipchamp.mp3')
                            .then((_) => _model.soundPlayer12!.play());
                      },
                      child: ClipRRect(
                        borderRadius: BorderRadius.circular(8.0),
                        child: Image.asset(
                          'assets/images/11_am.png',
                          width: 150.0,
                          height: 150.0,
                          fit: BoxFit.contain,
                        ),
